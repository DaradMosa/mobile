...
public final class ActivitySignInBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText signinpass;
  ...
  private ActivitySignInBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull TextInputEditText signinEmail, @NonNull Button signinbtn,
      @NonNull TextInputEditText signinpass, @NonNull TextInputLayout textInputLayout,
  ...
  public static ActivitySignInBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.signinpass;
      TextInputEditText signinpass = ViewBindings.findChildViewById(rootView, id);
      if (signinpass == null) {
        break missingId;
      }
      ...
      return new ActivitySignInBinding((ConstraintLayout) rootView, main, signinEmail, signinbtn,
          signinpass, textInputLayout, textInputLayout2, textInputLayout4, textView, textView2,
